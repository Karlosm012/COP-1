...
public class project3
{
	...
	public static void main(String[] args) 
	{
		...
		while (true) 
		{
			...
			case 1:
				...
				facultyID = checkID(facultyID, scnr);
			...
			case 2:
				...
				studentID = checkID(studentID, scnr);
	...
	//check to see if ID is in LLDDDD format
	public static String checkID(String id, Scanner scnr) {
			...
			try {
				if(id.length() != 6)
					...
					if(!(Character.isLetter(id.charAt(0))) || !(Character.isLetter(id.charAt(1)))) 
						throw new IdException("Invalid ID format. Must be LetterLetterDigitDigitDigitDigit");
					else if(!(Character.isDigit(id.charAt(2))) || !(Character.isDigit(id.charAt(3))) || 
	...
	public static String checkDepartment(String dept, Scanner scnr) {
		...
		while(true) {
			try {
				if((dept.equals("mathematics")) || (dept.equals("engineering")) || (dept.equals("sciences")))
					break;
				else
					throw new Exception();
			}
